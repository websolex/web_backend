...
const subscribeownEmail = async (email) => {
  ...
  <div style="margin:20px 0;">
    <h2 style="font-size:20px; color:#333; border-bottom:2px solid #f4f4f4; padding-bottom:10px;">Subsciber increed successfully!</h2>
    <p style="font-size:16px; color:#555;"><strong>Email:</strong> ${email}</p>
...
module.exports = { sendemail, subscribeEmail };
